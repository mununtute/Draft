...
namespace VCS.Page
{
    public class SebPage : BasePage
    {
        ...
        private IWebElement _Cookies => Driver.FindElement(By.CssSelector(".accept-selected > span"));
        ...
        public SebPage ClickCookiesButton()
        {
            _Cookies.Click();
            return this;
        }
        ...
        public SebPage CheckResult(int myWish) //79 105
        {
            ...
            Assert.IsTrue(calculateLoan > myWish, "Ne, paskolos nebus");
            return this;
        }
    }
}
